...
return(
    ...
    <div id="premimum">
        <div id="pimg">
          <img src="https://static.naukimg.com/s/0/0/i/ff-services-ot.png" alt=""/>
        </div>
        <div id="infor">
         ...
         <div class="si">
          <a href="#"><i class="fa-solid fa-bolt"></i>  Resume writing  `${">"}`</a>
          <a href="#"><i class="fa-solid fa-book-open"></i>  Priority applicant  `${">"}`</a>
          <a href="#"><i class="fa-solid fa-pen"></i>  Resume display  `${">"}`</a>
         </div>
        </div>
        <div id="pbtn">
