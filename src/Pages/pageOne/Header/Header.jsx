...
export default function Header(){
    ...
    <div id="navbar">
        ...
        <div class="pages">
         ...
         <div class="dropdown">
  <h2 class="dropbtn" onclick="window.location.href='jobs1.html'">Jobs</h2>
...
<div class="hr"></div>
  ...
  <div class="dropdown">
  <h2 class="dropbtn" onclick="window.location.href = 'jobs1.html'">Companies</h2>
  <div class="dropdown-content">
    <div>
...
<div class="hr"></div>
    ...
    <a href="#">company salaries</a>
     ...
     <a href="#">company reviews</a>
         ...
         <div class="dropdown">
  <h2 class="dropbtn" onclick="window.location.href = 'register.html'">Services</h2>
  <div class="dropdown-content">
    <div>
    ...
    <a href="#">job search booster</a>
     <h2><a href="#">Monthly subscription</a></h2>
...
<div class="hr"></div>
    ...
    <a href="#">Degree programs</a> 
        ...
        <div id="buttons">
          ...
          <button class="regis" onclick="window.location.href='register.html'">Register</button>
        </div>

        <div class="foremp">
              <div class="dropdown">
  <h2 class="dropbtn" onclick="window.location.href = '#'">For employers
    <i class="fa-solid fa-chevron-down"></i> </h2>
  <div class="dropdown-content">
    <div>
