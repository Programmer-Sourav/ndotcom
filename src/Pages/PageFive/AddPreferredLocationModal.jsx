...
export default function AddPreferredWorkLocationModal(){
    ...
    return(
        <>
        <Button onClick={onOpen} style={{background: "white", color: "#2f6b4f", outline: "none", height: "32px"}}>Add preffered work location</Button>
        ...
        <label><p>Select Industry:</p>
         <input type="text" value={prefferedLocation} onChange={setPrefferedLocation} className="inputbox"/>
        </label>
        </div>
        </ModalBody>   
        <ModalFooter>
