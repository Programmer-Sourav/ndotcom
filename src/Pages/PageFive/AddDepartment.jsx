...
export default function AddDepartment(){
    ...
    return(
        <>
        <Button onClick={onOpen} style={{background: "white", color: "#2f6b4f", outline: "none", height: "32px", width: "180px", display: "flex", justifyContent: "left", outline: "none", border:"none"}}>Add department</Button>
